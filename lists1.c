...
/**
* list_to_strings -its return an array of strings of the list->str
...
/**
* print_list -its prints all elements of a list_t linked list.
* @h:the pointer to first node.
*
* Return:the size of list.
*/
...
/**
* node_starts_with -its return node whose string starts with prefix.
...
/**
* get_node_index -its get the index of a node.
